            ...
            <Card className="mb-6 shadow-sm">
                <CardHeader>
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center text-secondary-foreground border border-border">
                            <MapPin size={20} />
                        </div>
                        <div>
                    ...
                    <CardContent className="p-4">
                        ...
                        <div className="mt-1 space-y-1">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-secondary font-medium">5:00 PM Onwards</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
